...
{{ TEXT = BLOCK }}
🚀 Добро пожаловать в <b>{{ config.company.name }}</b>!
<i>✨ Откройте для себя удобство и простоту с нашим ботом — вашим верным помощником!

🛠 Функционал:
🔑 Управление доступами за пару кликов.
💳 Удобные платежи: поддержка СБП и T-PAY.
📊 Статистика и отчёты в удобном формате.
🔄 Смена тарифов без админа.
📡 Настройка VPN: TLS и др.

💡 Почему стоит попробовать?
🕒 Экономьте время — всё под рукой.
🔒 Ваши данные в безопасности.
📱 Доступ с любого устройства.</i>
{{ END }}
{{ buttons = BLOCK }}
...
{
    "sendMessage": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (Android)</b>\n\n<b>Шаг 1:</b>\n\n1️⃣ **Скачай приложение Hiddify** из [Google Play Store 📲](https://play.google.com/store/apps/details?id=com.hiddify).\n\n<pre><i>Фото: На экране будет кнопка «Установить» после перехода по ссылке.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{
    "editMessageText": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (Android)</b>\n\n<b>Шаг 2:</b>\n\n2️⃣ **Открой приложение Hiddify** и выбери регион «Россия» 🇷🇺.\n\n<pre><i>Фото: На экране будет выбор региона в настройках.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
},
{
    "sendPhoto": {
        ...
        "caption": "На экране будет выбор региона в настройках.",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{
    "editMessageText": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (Android)</b>\n\n<b>Шаг 3:</b>\n\n3️⃣ **Нажми на кнопку «Старт» 🚀**, чтобы начать подключение к VPN.\n\n<pre><i>Фото: Главная кнопка для начала подключения VPN.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
},
{
    "sendPhoto": {
        "photo": "https://hkadm.github.io/hkdocs/marketplace/security/images/hiddifynext_android_2_hiddify.png",
        "caption": "Главная кнопка для начала подключения VPN.",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{
    "editMessageText": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (Android)</b>\n\n<b>Шаг 4:</b>\n\n4️⃣ **Добавь подписку**: на главной странице приложения нажми кнопку «Открыть страницу» 🔑.\n\n<pre><i>Фото: Кнопка для добавления подписки на главной странице.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
},
{
    "sendPhoto": {
        "photo": "https://hkadm.github.io/hkdocs/marketplace/security/images/hiddifynext_android_2_hiddify.png",
        "caption": "Кнопка для добавления подписки на главной странице.",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{
    "editMessageText": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (Android)</b>\n\n<b>Шаг 5:</b>\n\n5️⃣ **Подключись к VPN**: после добавления подписки, на экране появится большая кнопка для подключения к VPN 🔌.\n\n<pre><i>Фото: Кнопка для подключения VPN.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
},
{
    "sendPhoto": {
        "photo": "https://hkadm.github.io/hkdocs/marketplace/security/images/hiddifynext_android_2_hiddify.png",
        "caption": "Кнопка для подключения VPN.",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{
    "sendMessage": {
        "text": "🖥 <b>Полная инструкция по подключению Hiddify (iPhone)</b>\n\n<b>Шаг 1:</b>\n\n1️⃣ **Скачай приложение Hiddify** из [App Store 📱](https://apps.apple.com/ge/app/foxray/id6448898396).\n\n<pre><i>Фото: На экране будет кнопка «Установить» после перехода по ссылке.</i></pre>\n\n",
        "parse_mode": "HTML",
        "reply_markup": {
            "inline_keyboard": [
                [
...
{{ TEXT = BLOCK }}
✅ Спасибо, что выбрали {{ config.shmcustomlab.service_name }}

⏳ В ближайшее время ваш платеж будет проверен.
📩 Как только проверка завершится, вы получите уведомление от бота.

Если хочешь другие эмодзи или изменения, скажи! 🚀
{{ END }}
...
{{ con = ref(user.services.list_for_api( 'category', 'vpn-mz%' )).size }}
                ...
                {{ END }}
{{ TEXT = BLOCK }}
💰 Поступил запрос на прием платежа

👤 Пользователь: ({{ user.id }})
📛 Имя: {{ user.full_name }}
💬 Телеграм: @{{ user.settings.telegram.login }}
📦 Количество услуг: {{ con }}

🆔 ID платежа: {{ PaymentID }}
💵 Сумма к оплате: {{ AmmountToPay }}

🔎 Проверьте квитанцию и подтвердите оплату с помощью кнопки внизу.
✏️ При необходимости скорректируйте сумму платежа перед подтверждением.
{{ END }}
